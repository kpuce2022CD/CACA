...
import { SchemaCollectorImpl, validate } from './json-schema07-validator';
...
export class SingleYAMLDocument extends JSONDocument {
    ...
    matchSchemas(schema) {
        ...
        if (this.internalDocument.contents && schema) {
            validate(this.internalDocument.contents, this.internalDocument, schema, schema, new ValidationResult(this.isKubernetes), matchingSchemas, {
