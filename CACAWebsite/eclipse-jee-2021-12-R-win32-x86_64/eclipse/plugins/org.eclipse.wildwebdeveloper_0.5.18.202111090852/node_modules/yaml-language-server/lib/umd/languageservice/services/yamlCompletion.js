...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver/node", "yaml", "../utils/arrUtils", "../utils/indentationGuesser", "../utils/textBuffer", "../utils/json", "../utils/objects", "vscode-nls", "../parser/isKubernetes", "../utils/astUtils", "../utils/astUtils"], factory);
    }
    ...
    class YamlCompletion {
        ...
        doComplete(document, position, isKubernetes = false) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                else if (node && yaml_1.isScalar(node)) {
        ...
        getValueCompletions(schema, doc, node, offset, document, collector, types) {
            ...
            if (yaml_1.isPair(node)) {
                ...
                parentKey = yaml_1.isScalar(node.key) ? node.key.value.toString() : null;
                node = doc.getParent(node);
            }
