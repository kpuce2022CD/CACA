...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./jsonParser07", "yaml", "./yamlParser07", "vscode-json-languageservice", "./ast-converter", "../utils/arrUtils", "../utils/astUtils", "./json-schema07-validator", "../utils/strings"], factory);
    }
    ...
    const json_schema07_validator_1 = require("./json-schema07-validator");
    ...
    class SingleYAMLDocument extends jsonParser07_1.JSONDocument {
        ...
        getNodeFromPosition(positionOffset) {
            let closestNode;
         ...
         */
        matchSchemas(schema) {
            const matchingSchemas = new json_schema07_validator_1.SchemaCollectorImpl(-1, null);
            if (this.internalDocument.contents && schema) {
                json_schema07_validator_1.validate(this.internalDocument.contents, this.internalDocument, schema, schema, new jsonParser07_1.ValidationResult(this.isKubernetes), matchingSchemas, {
    ...
    class YamlDocuments {
        ...
        ensureCache(document, parserOptions, addRootObject) {
            ...
            if (cacheEntry.version !== document.version ||
                ...
                const doc = yamlParser07_1.parse(text, parserOptions);
