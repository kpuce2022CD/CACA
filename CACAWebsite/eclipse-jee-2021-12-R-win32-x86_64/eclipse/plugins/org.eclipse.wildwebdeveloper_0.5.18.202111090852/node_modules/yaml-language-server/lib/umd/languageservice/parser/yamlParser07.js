(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "yaml", "./yaml-documents", "./custom-tag-provider"], factory);
    }
     ...
     */
    function parse(text, parserOptions = exports.defaultOptions) {
        const options = {
            strict: false,
            customTags: custom_tag_provider_1.getCustomTags(parserOptions.customTags),
        ...
        return new yaml_documents_1.YAMLDocument(yamlDocs);
    }
    exports.parse = parse;
