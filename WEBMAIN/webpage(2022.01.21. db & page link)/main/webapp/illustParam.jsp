...
<body class="u-body">
	...
	<header class="u-clearfix u-grey-75 u-header u-header" id="sec-61f1">
		<div class="u-clearfix u-sheet u-sheet-1">
			<!-- 로고 이미지에 대한 링크 및 불러오기. 이미지 이름 및 링크, 크기 설정 등 가능.-->
              ...
              <rect y="1" width="16" height="2"></rect>
				...
				<div class="u-custom-menu u-nav-container">
					<ul class="u-nav u-unstyled u-nav-1">
						...
						<li class="u-nav-item">
							<!-- 암호화 된 링크를 copy하는 역할. 해당 페이지의 내용은 원격저장소와 clone 될것이다. --> <a
							class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"
							href="#" style="color: rgb(255, 0, 200);"
							style="padding: 10px 20px;">Copy Link!</a>
						</li>

						<li class="u-nav-item"><a
							class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"
							href="/illustCheck" style="padding: 10px 20px;">Back to
								ReCheck</a></li>
					</ul>
				</div>
	...
	<section style="padding: 5px;">
		...
		<!-- 저장 된, 불러와진 이미지 없을 경우, 문자열 empty 출력.-->
		<p text-align : center>
		<h1>Illustration to link is Empty.</h1>
		</p>
