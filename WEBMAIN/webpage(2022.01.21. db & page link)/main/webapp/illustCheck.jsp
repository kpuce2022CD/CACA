...
<link rel="stylesheet" href="Illustration.css" media="screen">
...
<body class="u-body">
	...
	<header class="u-clearfix u-grey-75 u-header u-header" id="sec-61f1">
		<div class="u-clearfix u-sheet u-sheet-1">
			<a href="#" data-page-id="59354799" class="u-image u-logo u-image-1"
				data-image-width="600" data-image-height="400" title="Home"> <!--<img src="images/saturn1.png" class="u-logo-image u-logo-image-1">-->
			</a> <span class="u-icon u-icon-circle u-text-palette-1-base u-icon-1">
				<svg class="u-svg-link" preserveAspectRatio="xMidYMin slice"
					viewBox="0 0 55 55" style="">
            <use xmlns:xlink="http://www.w3.org/1999/xlink"
						xlink:href="#svg-af4d"></use>
          </svg> <svg class="u-svg-content" viewBox="0 0 55 55" x="0px"
					y="0px" id="svg-af4d" style="enable-background: new 0 0 55 55;">
            <path
				...
				<div class="u-custom-menu u-nav-container">
					<ul class="u-nav u-unstyled u-nav-1">
						<li class="u-nav-item"><a
							...
							href="illustParam.jsp" style="color: rgb(255, 0, 200);"
							style="padding: 10px 20px;">Put Illustation</a></li>
	...
	<!-- 이미지 내부에만 padding 등 옵션을 주기 위해서 section 나눠놓음-->
	<section style="padding: 5px;">
		<!-- 기본 이미지들 포진해놓음. 한 줄에 3개씩. (img 옵션 고정해놓음.)-->
		<img
			src="images/d5133ddb53d4090042869e0903c8ab66b315608573c05deff9516e9ecc441c248158654e1211baba5f7d1c030f6d045742cddac8dfcca5e58d7de0_1280.jpg">
		<img
			src="images/4143947c24a8813eb327b2d6a3299b4a6cce549315d26db7f2d2d674ae0829b50d561aa209bd424c46337693e6fd3e9e7a2751df939f150849d024_1280.jpg">
		<img
			src="images/bf7bee11a640547042696b0a0136deb9103a6ddf629f76a3208fb3c9e0da4f263491efc4bf3960be0da7143d67be51e7eb43fb935926e0916fe848_1280.jpg">
	</section>


	<!-- 이미지 클릭하면 파란색 외곽선 생김. 이걸로 체크 기능. -->
	<script type='text/javascript'>
      $(function () {
        ...
        // 해당 name과 모두 동일한 체크박스 루프
        $("input[name='tmpChkbox']").each(function () {
          $(function () {
            $('img').click(function () {
              if ($('input:checkbox[name = "tmpChkbox[]"]').is(":checked") == true) {  // 체크된 체크박스만 외곽선을 씌움.
                var tmpval = $this.val();
                console.log(tmpval);
              }
              })
	...
	<!-- 이렇게 위에서 클릭된 이미지를 illustStored로 보내야 함. -->
