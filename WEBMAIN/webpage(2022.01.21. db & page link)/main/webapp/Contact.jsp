...
<script class="u-script" type="text/javascript" src="./css/jquery.js"
	defer=""></script>
<script class="u-script" type="text/javascript" src="./css/nicepage.js"
	defer=""></script>
...
<body class="u-body">
	<header class="u-clearfix u-grey-75 u-header u-header" id="sec-61f1">
		<div class="u-clearfix u-sheet u-sheet-1">
			<a href="Home.html" data-page-id="59354799"
				class="u-image u-logo u-image-1" data-image-width="600"
				data-image-height="400" title="Home"> <!--<img src="images/saturn1.png" class="u-logo-image u-logo-image-1">-->
			</a><span class="u-icon u-icon-circle u-text-palette-1-base u-icon-1"><svg
					class="u-svg-link" preserveAspectRatio="xMidYMin slice"
					viewBox="0 0 55 55" style="">
					<use xmlns:xlink="http://www.w3.org/1999/xlink"
						xlink:href="#svg-af4d"></use></svg>
				<svg class="u-svg-content" viewBox="0 0 55 55" x="0px" y="0px"
					id="svg-af4d" style="enable-background: new 0 0 55 55;">
					<path
	...
	c-0.252,0.137-0.502,0.297-0.752,0.476C5.276,41.792,2,35.022,2,27.5z"></path></svg></span>
          ...
          <symbol id="menu-hamburger" viewBox="0 0 16 16"
            ...
            <rect y="1" width="16" height="2"></rect>
				...
				<!-- 웹페이지 평시 상태일 때 버튼 스타일 및 링크, 이름 지정 -->
				<div class="u-custom-menu u-nav-container">
					<ul class="u-nav u-unstyled u-nav-1">
						<li class="u-nav-item"><a
							class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"
							href="contactEdit.jsp" style="color: rgb(255, 0, 200);"
							style="padding: 10px 20px;">Edit</a></li>
  ...
  <div class="u-custom-menu u-nav-container-collapse">
   ...
   -->
	...
	<section class="u-align-center u-clearfix u-section-1" id="sec-0c9e">
		<div class="u-clearfix u-sheet u-sheet-1">
			<div
				class="u-align-left u-container-style u-group u-palette-5-dark-3 u-group-1">
				<div class="u-container-layout u-container-layout-1">
					<h1 class="u-text u-text-default u-text-1">Contact</h1>
				</div>
			</div>
			<img class="u-image u-image-default u-image-1"
				data-image-width="1280" data-image-height="819"
				src="images/b15142ad42bf60f5c46df0d11bce7b70a01248ab25fade6148f94fee3bee0deb04ae482eb97355d235a90acd80d992a48454b2a47467291c2a1bdd_1280.jpg">
			<div
				class="u-align-left u-border-2 u-border-grey-75 u-container-style u-group u-palette-5-dark-3 u-group-2">
				<div class="u-container-layout u-container-layout-2">
					<p class="u-text u-text-2">
						CONTACT<br>WITH US&nbsp;
					</p>
					<!-- <img class="u-border-2 u-border-grey-75 u-image u-image-default u-image-2" src="images/149608850-600e4d59-772b-4d07-981d-5b61b5c39cba.png" alt="" data-image-width="942" data-image-height="998"> -->
				</div>
        ...
        <p class="u-text u-text-4">the title</p> -->
			...
			<div
				class="u-align-center u-border-2 u-border-grey-75 u-container-style u-group u-palette-5-dark-3 u-group-3">
						...
						<form action="#" method="POST"
							...
							<div class="u-form-group u-form-name u-form-group-1">
								<label for="name-5a14" class="u-form-control-hidden u-label"
									wfd-invisible="true">Name</label> <input type="text"
							...
							<div class="u-form-email u-form-group u-form-group-2">
								<label for="email-5a14" class="u-form-control-hidden u-label"
									wfd-invisible="true">Email</label> <input type="email"
									placeholder="Enter a valid email address" id="email-5a14"
									name="email"
									class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white"
									required="">
							</div>
							...
							<div
								...
								<a href="#"
									class="u-border-2 u-border-palette-5-dark-2 u-btn u-btn-submit u-button-style u-hover-black u-palette-5-dark-2 u-text-body-alt-color u-text-hover-white u-btn-1">Submit</a>
