...
<link rel="stylesheet" href="./css/About.css" media="screen">
  ...
  <div class="u-custom-menu u-nav-container">
      <ul class="u-nav u-unstyled u-nav-1">
            <li class="u-nav-item">
              <a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="aboutEdit.jsp"  style ="color: rgb(255, 0, 200);" style="padding: 10px 20px;">Edit</a>
            </li>

                      <li class="u-nav-item">
                      <a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Illustration.jsp" style="padding: 10px 20px;">Illustation</a>
                      </li>
    
                      <li class="u-nav-item">
                      <a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="About.jsp" style="padding: 10px 20px;">About</a>
                      </li>
    
                      <li class="u-nav-item">
                      <a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Contact.jsp" style="padding: 10px 20px;">Contact</a>
                      </li>
  ...
  <div class="u-custom-menu u-nav-container-collapse">
   ...
   -->
    ...
    <section class="u-clearfix u-section-1" id="carousel_63d1">
      <div class="u-clearfix u-sheet u-sheet-1">
                    ...
                    <div class="u-layout-row">
                      <div class="u-align-center-sm u-align-center-xs u-container-style u-layout-cell u-left-cell u-size-60 u-layout-cell-1">
                        <div class="u-container-layout u-container-layout-1">
                          <h1 class="u-text u-text-default u-text-1">Mr. Bread</h1>
                          <p class="u-text u-text-default u-text-2">The extraordinary illustrator<br>born in korea
                          </p>
                          <p class="u-text u-text-3">Paragraph. Sed molestie tellus eros, sed ultricies nisi egestas ut. Suspendisse id ornare nulla. Vestibulum in condimentum diam, a luctus leo. Sed vel pharetra felis. Nullam eu tincidunt erat. Mauris sit amet venenatis dui. Fusce nulla odio, tristique sit amet malesuada quis, gravida eget nunc. Fusce vulputate vulputate turpis, id scelerisque justo ullamcorper in.</p>
                          <p class="u-text u-text-4">Sed at vestibulum augue. Aenean vel dapibus nisi. Fusce nec odio luctus, bibendum velit a, placerat sapien.&nbsp;Aliquam et sem odio. In ullamcorper nisi nunc, et molestie ipsum iaculis sit amet.&nbsp;In porta nec dolor non consectetur. Duis volutpat euismod neque sed blandit.&nbsp;Curabitur non magna porttitor nulla viverra pretium.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="u-layout-col">
                  <div class="u-container-style u-layout-cell u-right-cell u-size-60 u-layout-cell-2">
                    <div class="u-container-layout u-container-layout-2">
                      <img class="u-image u-image-1" src="images/bread.png" data-image-width="350" data-image-height="350">
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section class="u-clearfix u-section-2" id="sec-f752">
