...
<body class="u-body">
			...
			<nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
				<div class="menu-collapse"
					...
					<a
						...
						href="#"> <svg viewBox="0 0 24 24"></svg> <svg version="1.1"
				...
				<div class="u-custom-menu u-nav-container">
					<ul class="u-nav u-unstyled u-nav-1">
						<li class="u-nav-item"><a
							...
							href="/login" style="padding: 10px 20px;"></a></li>
					</ul>
				</div>
			</nav>
		</div>
	...
	<section class="u-align-center u-clearfix u-section-1" id="sec-71c2">
		...
		<div class="u-clearfix u-sheet u-sheet-1">
			...
			<div
				class="u-align-center u-container-style u-group u-palette-5-dark-3 u-radius-50 u-shape-round u-group-1">
				<div class="u-container-layout u-valign-top u-container-layout-1">
					<span class="u-icon u-icon-circle u-text-palette-1-dark-1 u-icon-1">
						<svg class="u-svg-link" preserveAspectRatio="xMidYMin slice"
							viewBox="0 0 45.532 45.532" style="">
							<use xmlns:xlink="http://www.w3.org/1999/xlink"
								xlink:href="#svg-862c"></use></svg> <svg class="u-svg-content"
							viewBox="0 0 45.532 45.532" x="0px" y="0px" id="svg-862c"
						...
						<form action="LoginServlet" method="post"
							...
							<div class="u-align-left u-form-group u-form-submit">
								<input type="submit" value=Login
									class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-palette-1-dark-1 u-radius-50 u-btn-1">
							</div>
						</form>
